...
public class SearchPostcode extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.search_postcode);
        ...
        if (btn1 != null) {
            btn1.setOnClickListener(new View.OnClickListener() {
                ...
                public void onClick(View v) {
                    startActivity(new Intent(SearchPostcode.this, SearchLocation.class));
                }
            });
        }
        ...
        if (btn2 != null) {
            btn2.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(SearchPostcode.this, SearchName.class));
                }
            });
        }
        ...
        if (btn3 != null) {
            btn3.setOnClickListener(new View.OnClickListener() {
                @Override
                public void onClick(View v) {
                    startActivity(new Intent(SearchPostcode.this, SearchPostcode.class));
                }
            });
        }
    }
     ...
     */
    public void show_locations(String input) {
        ...
        if (networkInfo != null && networkInfo.isConnected()) {
            ...
            String address = "http://sandbox.kriswelsh.com/hygieneapi/hygiene.php?op=s_postcode&postcode=" + query;
...
//        rating.setImageResource(res);
    ...
    private View.OnClickListener tableRowOnClickListener = new View.OnClickListener() {
        @Override
        public void onClick(View v) {
            Intent intent = new Intent(SearchPostcode.this, MapsActivity.class);
